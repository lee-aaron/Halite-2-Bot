...
public class Navigation {
    ...
    public static ThrustMove navigateShipToAvoid(
            final GameMap gameMap,
            final Ship ship,
            final Entity dockTarget,
            final int maxThrust)
    ...
    public static ThrustMove navigateShipAroundTarget(
            final GameMap gameMap,
            final Ship ship,
            final Position targetPos,
            final int maxThrust,
            ...
            final double angularStepRad)
    {
        ...
        if (avoidObstacles && !gameMap.objectsBetween(ship, targetPos).isEmpty()) {
            ...
            return navigateShipAroundTarget(gameMap, ship, newTarget, maxThrust, true, (maxCorrections-1), angularStepRad);
        }
